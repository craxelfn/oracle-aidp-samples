...
The refresh token persists to ``$HOME/.aidp-fusion-autopilot/oac-token.json``
...
class OacOauthFlow:
    ...
    Args:
        ...
        token_path: Where to persist the token bundle. Defaults to
            ``~/.aidp-fusion-autopilot/oac-token.json``. Created with mode 0600.
    ...
    def __init__(
        ...
        *,
        ...
        if token_path is None:
            ...
            token_path = home / ".aidp-fusion-autopilot" / "oac-token.json"
