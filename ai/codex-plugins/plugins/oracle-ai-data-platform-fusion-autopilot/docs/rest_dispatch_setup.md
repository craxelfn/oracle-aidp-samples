...
- Skill: `fusion-tc26-run` (development harness in the original source project; not shipped with this package) — the empirical-probe harness this CLI productizes
...
- REST-dispatch `--resume`: **shipped** as `P1.5ε-fix5` (2026-06-03)
