...
This violated the plugin's mission (per CODEX.md): the fusion-autopilot
...
**frozen reference implementations** per CODEX.md "v1 + v2
...
* CODEX.md "v1 + v2 coexistence (migration state)" — the
