...
operators open Codex in the project directory and invoke the
...
contract lives in
`skills/medallion-author/SKILL.md`.
...
your profile — open Codex and ask the skill to draft an overlay.
...
| `modelId` | `gpt-5-codex` (from runtime) | Identifies the LLM that drafted |
