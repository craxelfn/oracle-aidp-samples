...
FROM (
  SELECT
    ...
    coa.CodeCombinationSegment7                AS CodeCombinationSegment7,
    coa.CodeCombinationSegment8                AS CodeCombinationSegment8,
    coa.CodeCombinationSegment9                AS CodeCombinationSegment9,
    coa.CodeCombinationSegment10               AS CodeCombinationSegment10,
