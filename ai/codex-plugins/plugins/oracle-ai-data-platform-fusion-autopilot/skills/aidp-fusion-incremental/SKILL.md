...
description: >-
  Run guarded incremental Fusion refreshes with drift, watermark, plan-hash, and precondition checks. Use for daily deltas, scoped refreshes, resume requests, or incremental-run failures.
---
