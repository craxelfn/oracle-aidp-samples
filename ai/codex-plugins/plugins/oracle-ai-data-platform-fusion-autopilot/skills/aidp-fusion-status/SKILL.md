...
description: >-
  Produce a read-only Fusion-to-AIDP pipeline health and freshness report by comparing run state with live catalog materialization. Use for success, failure, stale, missing, untracked, or rerun questions.
---
