...
description: >-
  Resolve AIDP workspace and cluster identifiers from human-friendly names and write aidp.config.yaml. Use when configuring the Fusion Autopilot, filling workspace or cluster keys, or avoiding manual identifier lookup.
---
