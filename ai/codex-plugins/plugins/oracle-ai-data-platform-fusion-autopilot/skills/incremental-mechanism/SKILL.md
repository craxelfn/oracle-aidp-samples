...
description: >-
  Choose and verify the safest low-cost refresh strategy for a Fusion AIDP bronze, silver, or gold node. Use when deciding between native incremental, watermark delta, scoped recompute, or replacement behavior.
---
