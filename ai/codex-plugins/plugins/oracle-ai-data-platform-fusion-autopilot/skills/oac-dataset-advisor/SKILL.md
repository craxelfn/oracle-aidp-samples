...
description: >-
  Translate a dashboard request into an OAC dataset plan grounded in live AIDP gold tables and existing OAC catalog evidence. Use to select tables, columns, joins, reusable datasets, or identify a true mart gap.
---
...
seeded, or with columns that don't match. (Same rule as CODEX.md "live
