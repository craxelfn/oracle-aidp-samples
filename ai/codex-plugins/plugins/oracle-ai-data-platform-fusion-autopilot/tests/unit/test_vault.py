...
from oracle_ai_data_platform_fusion_autopilot.utils import vault
...
class TestMockMode:
    def test_resolves_via_mock_env(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv(
            "AIDP_FUSION_AUTOPILOT_MOCK_SECRETS",
    ...
    def test_passthrough_for_plain_string(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("AIDP_FUSION_AUTOPILOT_MOCK_SECRETS", "ocid1.vaultsecret.oc1.iad.x=v")
